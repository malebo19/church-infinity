...
if(!isset($_POST["user_id"],$_POST["content"],$_FILES["attachment"]))
{
...
//check group name
$sql = "INSERT INTO `testimonies` ( `document`, `content`) VALUES ('$filePath','$content')";
$result = mysqli_query($conn, $sql);
if ($result==false) {
...
returnJson(["status"=>true,"message"=>"testimony created"]);
