        ...
        <div id="main-wrapper">
            <div class="row">
                <div class="col-md-12">
                                ...
                                <table id="example2" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Member</td>
                                            <td>Sabelo Smith</td>
                                            <td>sabelosmith@gmail.com</td>
                                            <td>0732456789</td>
                                            <td>Rhapsody</td>
                                            <td>Cell2</td>
                                            <td>Brother Micheal</td>
                                        </tr>
                                        <!-- Row 2 -->
                                        <tr>
                                            <td>Brother</td>
                            ...
                            <div class="table-responsive">
                                <table id="example2" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Dcn</td>
                                            <td>Church Coordinator</td>
                                            <td>Njabulo Hlatshwayo</td>
                                            <td>nhlatshwayo@gmail.com</td>
                                            <td>0732456789</td>
                                            <td>Sound</td>
                    ...
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h4 class="panel-title">Sacraments</h4>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="example2" class="display table" style="width: 100%; cellspacing: 0;">
