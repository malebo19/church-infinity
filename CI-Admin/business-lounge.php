                            ...
                            <div class="table-responsive">
                                <table id="example2" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    <tbody>
                                        ...
                                        <!-- row 1 -->
                                        <tr>
                                            <td>Tiber Construction</td>
                                            <td>tiber.co.za</td>
                                            <td>info@tiber.co.za</td>
                                            <td>0114307700</td>
                                            <td>41 Rivonia Rd, Morningside, 2057</td>
                                            <td>Construction</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Open Food</td>
                                            <td>openfood.co.za</td>
                                            <td>info@openfood.co.za</td>
                                            <td>0124307801</td>
                                            <td>1 Richmond Ave, Auckland Park, 2092</td>
                                            <td>Food/Catering</td>
                                        ...
                                        <!-- row 3 -->
                                        <tr>
                                            <td>i22 Digital Agency</td>
                                            <td>i22digital.co.za</td>
                                            <td>info@i22digitalagency.co.za</td>
                                            <td>0124327670</td>
                                            <td>23 Jan Smuts Avenue, Forestown, 2067</td>
                                            <td>Marketing</td>
                                        </tr>
