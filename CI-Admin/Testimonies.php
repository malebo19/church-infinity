    ...
    <div class="page-inner">
        ...
        <div class="page-title">
            <div class="page-breadcrumb">
                <ol class="breadcrumb">
                    <li><a href="index.html">Testimonnies</a></li>
                    <li class="active">View Testimonies</li>
                </ol>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-white">
                        ...
                        <h1 class="text-center m-3 text-info ">Current Testimonies</h1>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <textarea type="text" name='content' id="position-input" class="form-control" placeholder="Content" required></textarea>
                                                </div>
                                                <div class="form-group">
                ...
                <script>
                    function formSubmit(e) {
                        ...
                        console.log(data);
                        $.ajax({
                            url: "http://localhost/api/admin/testimonies/create",
                            method: "POST",
                            data: form_data,
                            contentType: false,
                            cache: false,
